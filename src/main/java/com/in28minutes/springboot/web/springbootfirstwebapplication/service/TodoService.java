...
public class TodoService {
    ...
    static {
        todos.add(new Todo(1, "jake", "Learn Spring MVC", new Date(),
                false));
        todos.add(new Todo(2, "jake", "Learn Struts", new Date(), false));
        todos.add(new Todo(3, "jake", "Learn Hibernate", new Date(),
                false));
    }
